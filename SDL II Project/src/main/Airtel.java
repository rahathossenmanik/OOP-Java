...
public class Airtel {
	...
	Airtel(){
		JFrame frame = new JFrame("Airtel");
		...
		button1 = new JButton("Check Number");
		button2 = new JButton("Check Minute");
		button3 = new JButton("Check Data Balance");
		button4 = new JButton("Check Balance");
		button5 = new JButton("Check SMS");
		button6 = new JButton("Call Me Back");
